...
public class SimpleOrgChartTreeItem extends OrganizationChartTreeItem{
    ...
    public SimpleOrgChartTreeItem(OrganizationChartTree diagramTree, OrganizationChartTreeItem dad, OrganizationChartTreeItem item) {
        super(diagramTree, dad, item);
    }

    public SimpleOrgChartTreeItem(OrganizationChartTree diagramTree, XShape xShape, OrganizationChartTreeItem dad, short level, double num){
    ...
    public void initTreeItems(){
        ...
        if(xFirstChildShape != null){
            ...
            m_FirstChild = new SimpleOrgChartTreeItem(getDiagramTree(), xFirstChildShape, this, firstChildLevel , firstChildPos);
        ...
        if(xFirstSiblingShape != null){
            ...
            m_FirstSibling = new SimpleOrgChartTreeItem(getDiagramTree(), xFirstSiblingShape, m_Dad, firstSiblingLevel , firstSiblingNum);
    ...
    public void convertTreeItems(OrganizationChartTreeItem treeItem){
        if(treeItem.isFirstChild()){
            m_FirstChild = new SimpleOrgChartTreeItem(getDiagramTree(), this, treeItem.getFirstChild());
            m_FirstChild.convertTreeItems(treeItem.getFirstChild());
        }
        if(treeItem.isFirstSibling()){
            m_FirstSibling = new SimpleOrgChartTreeItem(getDiagramTree(), getDad(), treeItem.getFirstSibling());
